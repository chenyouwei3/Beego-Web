...
func (c *usercenterClient) Login(ctx context.Context, in *GetUserInfoReq, opts ...grpc.CallOption) (*GetUserInfoResp, error) {
...
type UsercenterServer interface {
	Login(context.Context, *GetUserInfoReq) (*GetUserInfoResp, error)
...
func (UnimplementedUsercenterServer) Login(context.Context, *GetUserInfoReq) (*GetUserInfoResp, error) {
...
func _Usercenter_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsercenterServer).Login(ctx, req.(*GetUserInfoReq))
	}
